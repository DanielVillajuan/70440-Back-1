...
router.post("/:idCart/product/:idProd", async (req, res) => {
  ...
  // const cart = recupero el carrito
  // const prod = cart.find() busco el producto dentro del carrito
  // cart.products.push({id: "asdasd-asdasd", quantity: 1}) si no existe el producto dentro del array de productos del carrito

  // cart.products = { id: "asdasd-sadasd-asd", quantity: 2 }
  try {
